...
export class AlCollectorStatusClientInstance {
     ...
     *
     * */
    async getCollectorStatusHistory(accountId: string, statusId: string, params?: AlCollectorStatusQueryParams): Promise<AlCollectorStatusHistoryResponse> {
     ...
     *
     * */
     async getCollectorLastStatus(accountId: string, statusId: string, params?: AlCollectorStatusQueryParams): Promise<AlCollectorStatusHistoryResponse> {
        return this.client.get<AlCollectorStatusHistoryResponse>({
            service_stack: AlLocation.InsightAPI,
            service_name: this.serviceName,
            version: this.serviceVersion,
     ...
     *
     * */
     async reportCollectorStatus(accountId: string, statusId: string, stream: string, payload: AlCollectorStatusObject): Promise<void> {
