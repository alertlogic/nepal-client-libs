...
/**
 * Scan Window specifies when assets within a scope of a schedule should be scanned, adhering to the `scan_frequency` parameter. Depending on the `type_of_window` parameter different time windows can be specified.
 */
